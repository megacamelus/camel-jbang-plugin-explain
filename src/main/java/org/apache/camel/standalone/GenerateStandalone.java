...
import org.apache.camel.jbang.ai.GenerateServiceClient;
...
public class GenerateStandalone implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        GenerateServiceClient
                serviceClient = new GenerateServiceClient(url, apiKey, modelName, systemPrompt, description, host, port, collectionName);
